"""
Represent Clo (row.representclo.com) scraper.
Scrapes products from a Shopify store using the native JSON API.
API: https://row.representclo.com/products.json?limit=250&page=N (5 pages)
"""
...
class RepresentCloScraper(BaseScraper):
    BRAND_SLUG = "represent-clo"
    BRAND_NAME = "Represent Clo"
    BASE_URL = "https://row.representclo.com/"
    PRODUCTS_API_URL = "https://row.representclo.com/products.json"
    ...
    def _parse_shopify_json(self, data: dict, url: str) -> ScrapedProduct:
        ...
        category = data.get("product_type", "") or "Fashion"
