"""
Hex Beauty Lab (hexbeautylab.com) scraper.
Vegan, cruelty-free, results-driven skincare brand.
...
class HexBeautyLabScraper(BaseScraper):
    BRAND_SLUG = "hex-beauty-lab"
    BRAND_NAME = "Hex Beauty Lab"
    BASE_URL = "https://hexbeautylab.com/"
    PRODUCTS_API_URL = "https://hexbeautylab.com/products.json"
    ...
    def _parse_shopify_json(self, data: dict, url: str) -> ScrapedProduct:
        ...
        # Category — use product_type from Shopify, fallback to Skincare
        category = data.get("product_type", "") or "Skincare"
