"""
YoungLA (youngla.com) scraper.
Scrapes products from a Shopify store using the native JSON API.
API: https://www.youngla.com/products.json?limit=250&page=N
"""
...
class YoungLAScraper(BaseScraper):
    BRAND_SLUG = "youngla"
    BRAND_NAME = "YoungLA"
    BASE_URL = "https://www.youngla.com/"
    PRODUCTS_API_URL = "https://www.youngla.com/products.json"
    ...
    def _parse_shopify_json(self, data: dict, url: str) -> ScrapedProduct:
        ...
        # Category
        category = data.get("product_type", "") or "Apparel"
