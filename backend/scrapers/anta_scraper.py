"""
ANTA (anta.com) scraper.
Official ANTA US website.
...
class AntaScraper(BaseScraper):
    BRAND_SLUG = "anta"
    BRAND_NAME = "ANTA"
    BASE_URL = "https://anta.com/"
    PRODUCTS_API_URL = "https://anta.com/products.json"
    ...
    def _parse_shopify_json(self, data: dict, url: str) -> ScrapedProduct:
        ...
        # Category
        category = data.get("product_type", "") or "Shoes/Apparel"
