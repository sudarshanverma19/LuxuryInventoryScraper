"""
Hustle Culture (hustleculture.co.in) scraper.
Scrapes Streetwear products from a Shopify store using the native JSON API.
This bypasses browser rendering entirely for maximum speed and avoids popups.
"""
...
class HustleCultureScraper(BaseScraper):
    BRAND_SLUG = "hustle-culture"
    BRAND_NAME = "Hustle Culture"
    BASE_URL = "https://hustleculture.co.in/"
    PRODUCTS_API_URL = "https://hustleculture.co.in/products.json"
